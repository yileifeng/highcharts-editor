...
const validateConfig = () => {
    const checkValidation = validator.validate(updatedConfig.value, highchartsSchema as any);
    console.log('validating: ', updatedConfig.value, highchartsSchema);
    if (checkValidation.errors.length) {
        ...
        chartStore.setChartConfig(JSON.parse(updatedConfig.value));
    }
};
</script>
